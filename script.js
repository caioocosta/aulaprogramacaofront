document.addEventListener('DOMContentLoaded', () => {
    ...
    if (hamburger && nav) {
        ...
        // Opcional: Fecha o menu se um link for clicado (melhora a UX mobile)
    ...
    // 2. Chama a função de validação de formulário
    setupFormValidation();
});


// 2. FUNCIONALIDADE DE VALIDAÇÃO DE FORMULÁRIO
function setupFormValidation() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        form.querySelectorAll('input[required], select[required]').forEach(input => {
            ...
            // OBS: Validação de CPF/CEP complexa é feita com o 'pattern' do HTML, 
            // mas adicionamos o aviso visual aqui.
        });
...
// Função auxiliar para validação básica de email (pode ser mais complexa)
